...
const documents = [
  {
    name: "Rajesh_Sharma_ID_Proof.pdf",
    size: "2.4 MB",
    date: "Oct 12",
    type: "pdf",
  },
  {
    name: "Smita_Sharma_Medical_Consent_Form.docx",
    size: "1.1 MB",
    date: "Sep 05",
    type: "docx",
  },
...
const activities = [
  {
    ...
    desc: "Smita Sharma marked as primary emergency contact.",
    time: "Today, 10:45 AM - by Admin User",
    dot: theme.colors.success,
  },
  {
    label: "Document Uploaded",
    desc: "Medical_Consent_Form.docx uploaded for Smita Sharma.",
    time: "Oct 12, 02:15 PM - by Admin User",
    dot: theme.colors.info,
  },
  {
    label: "Guardian Added",
    desc: "Vikas Gupta added as authorized pickup contact.",
  ...
  const handleSaveGuardian = (form) => {
    setGuardians((prev) => [
      ...prev,
      {
        ...
        avatar: `https://i.pravatar.cc/72?img=${20 + prev.length}`,
        tags: prev.length === 0 ? ["Primary"] : ["Secondary"],
        phone: form.phone,
        email: form.email || "—",
        address: form.sameAddress
          ? "Same as student's residential address"
          : "—",
        verified: false,
        emergency: false,
      },

...
const ViewStudentDetails = () => {
  ...
  const handlePaymentSuccess = (payload) => {
    const amount = Number(payload.amountReceived) || 0;
  ...
  return (
    ...
    >
      ...
      {successMessage && (
        <div
          style={{
            ...
            padding: "14px 18px",
            borderRadius: theme.radius.lg,
            background: theme.colors.successSoft || "#DCFCE7",
            color: theme.colors.success || "#166534",
            border: `1px solid ${theme.colors.successBorder || "#86EFAC"}`,
            fontSize: "14px",
            fontWeight: 600,
          }}
        >
      ...
      {activeTab === "Fees & Payments" && (
        <FeesTab onRequestCollect={() => setShowCollectFees(true)} />
      )}
      ...
      <CollectFeesModal
        open={showCollectFees}
        onOpenChange={setShowCollectFees}
